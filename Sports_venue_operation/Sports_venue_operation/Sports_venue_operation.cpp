...
void administator()
{
	...
	do {
		...
		cout << "\t\t     Enter 4 for Member List " << endl;
		cout << "\t\t     Enter 5 for Remove a specific member" << endl;
...
void memberBooking() {
	...
	do
	{
		...
		case 1:
		{
			cout << "To book a Basketball court enter number 1 (9 courts available)" << endl;
			cout << "To book a Tennis court enter number 2     (9 courts available)" << endl;
			cout << "To book a Badminton court enter number 3  (9 courts available)" << endl;
			ct.book(1);
			break;
		}
		case 2:
...
int main()
{
	...
	cout << "----------------------------------------------------" << endl;
	gotoxy(55, 7);
	cout << "||        Sports Venue Operation System       ||" << endl;
	gotoxy(55, 9);
	cout << "----------------------------------------------------" << endl;
	/*gotoxy(47, 11);*/
	gotoxy(56, 13);
	...
	gotoxy(64, 15);
	cout << "Irushi Kumarathissa   (EG/2021/4634)" << endl;
	gotoxy(64, 16);
	cout << "Kasunie Senevirathne  (EG/2021/4806)" << endl;
	gotoxy(64, 17);
	cout << "Pasan Thilakshana     (EG/2021/4831)" << endl << endl;
	system("pause");
	system("cls");
	system("color E0");
